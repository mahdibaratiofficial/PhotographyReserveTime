    <nav class="navbar navbar-expand-lg   bg-light navbar-style-two text-center">
        <div class="container">
            <a class="navbar-brand" href="index-3.html"><img src="assets/img/logo.png" width="100px" alt="logo"></a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item"><a class="nav-link" href="#services">خدمات ما</a></li>
